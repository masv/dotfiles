...
require('packer').startup(function(use)
  ...
  use 'tpope/vim-surround' -- Manipulate parentheses, brackets, quotes, XML tags, and more
  use 'tpope/vim-vinegar' -- Improve file browsing (netrw)

  -- Language support
  use 'elixir-editors/vim-elixir'
  use 'tpope/vim-bundler' -- Support Bundler
  use 'tpope/vim-rails' -- Ruby on Rails power tools
  use 'tpope/vim-rake' -- like rails.vim without the rails
  use "williamboman/mason.nvim" -- Package manager for LSPs and such
  use "williamboman/mason-lspconfig.nvim" -- Bridges mason.vim and lspconfig
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'eex', 'elixir', 'lua', 'ruby' },
